interface GembaQuestion {
  id: number;
  category: 'Process Observation' | 'People Engagement' | 'Visual Management' | 'Problem Solving' | 'Continuous Improvement';
  text: string;
  text_de?: string;
  text_tr?: string;
}

export const gembaQuestions: GembaQuestion[] = [
  // Process Observation
