<script lang="ts">
  ...
  import { ChevronRight, ChevronLeft, Save, Brain, RefreshCw, Circle as XCircle,ClipboardCheck, ArrowLeft, Clock } from 'lucide-svelte';
...
<div class="bg-white shadow-sm">
  <div class="max-w-4xl mx-auto px-6 py-4 flex items-center">
    ...
    <div class="flex-1 flex justify-center">
      <div class="flex items-center space-x-2 bg-blue-50 px-3 py-1.5 rounded-lg">
        <AuditTimer 
