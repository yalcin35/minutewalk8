...
var root_8 = template(`<button class="w-12 h-12 rounded-xl bg-white text-green-500 shadow-lg
...
var root_12 = template(`<button class="w-12 h-12 rounded-xl bg-green-500 text-white shadow-lg
               flex items-center justify-center transform transition-all
               duration-200 hover:scale-105 active:scale-95
               focus:outline-none focus:ring-2 focus:ring-green-500
               focus:ring-offset-2"><!></button>`);
...
var root = template(`<div class="min-h-screen bg-gradient-to-br from-green-50 to-white"><div class="fixed top-0 left-0 w-full h-1 bg-gray-100"><div class="h-full bg-green-500 transition-all duration-300 ease-out"></div></div> <button class="fixed top-4 right-4 flex items-center space-x-2 px-4 py-2 bg-red-50 
           text-red-600 rounded-lg hover:bg-red-100 transition-colors z-50"><!> <span>Exit</span></button> <div class="bg-white shadow-sm"><div class="max-w-4xl mx-auto px-6 py-4 flex justify-between items-center"><div><h1 class="text-sm font-medium text-green-600"> </h1> <p class="text-gray-500 text-sm mt-1"> </p></div> <div class="flex items-center space-x-2 bg-green-50 px-3 py-1.5 rounded-lg"><!></div> <div class="flex-1 max-w-[100px]"></div></div></div> <div class="max-w-4xl mx-auto p-6 space-y-8"><div class="space-y-8"><div class="bg-white rounded-2xl shadow-lg p-6 space-y-6"><div class="flex items-start space-x-4"><div class="bg-green-100 p-2 rounded-full flex-shrink-0 mt-1"><!></div> <h2 class="text-xl font-light text-gray-900"> </h2></div> <!> <div class="flex justify-between items-center py-4"></div> <div class="space-y-2"><label class="text-sm font-medium text-gray-700">Evidence Photos</label> <!> <!></div> <div class="space-y-2"><label class="text-sm font-medium text-gray-700"> </label> <textarea class="w-full p-4 h-24 rounded-xl bg-gray-50
...
function _page($$anchor, $$props) {
  ...
  onMount(async () => {
    try {
      const { data: setupData, error: setupError } = await supabase.from("audit_setups").select(`
          ...
          audit_type,
          start_time
        `).eq("audit_type", "hse").order("created_at", { ascending: false }).limit(1).single();
  ...
  async function requestAIInsights() {
    ...
    set(aiError, null);
    try {
      const insight = await getAIInsights(get(currentQuestion).text, get(currentAnswer).rating, get(currentAnswer).notes, get(currentAnswer).photos.map((p) => p.file), "hse");
  ...
  function navigate(direction) {
    ...
    } else if (direction === "next" && get(currentQuestionIndex) < hseQuestions.length - 1) {
  ...
  legacy_pre_effect(() => get(currentQuestionIndex), () => {
    set(currentQuestion, hseQuestions[get(currentQuestionIndex)]);
  });
  legacy_pre_effect(
  ...
  legacy_pre_effect(() => (get(currentQuestionIndex), hseQuestions), () => {
    progress.set(get(currentQuestionIndex) / (hseQuestions.length - 1) * 100);
  });
  ...
  Shield(node_2, { class: "w-5 h-5 text-green-600" });
  reset(div_11);
  var h2 = sibling(div_11, 2);
  ...
  each(div_12, 4, () => Array(5), index, ($$anchor2, _, i, $$array) => {
    var button_1 = root_2();
    ...
    template_effect(() => set_class(button_1, 1, `w-14 h-14 rounded-xl transition-all duration-200
                     ...
                     ${(get(currentAnswer).rating === i + 1 ? "bg-green-500 text-white shadow-lg" : "bg-white shadow-md") ?? ""}`));
  ...
  var node_11 = sibling(node_10, 2);
  {
    var consequent_4 = ($$anchor2) => {
      ...
      transition(3, div_17, () => fly, () => ({ y: 10, duration: 300 }));
  ...
  var node_14 = sibling(node_12, 2);
  {
    ...
    if_block(node_14, ($$render) => {
      if (get(currentQuestionIndex) === hseQuestions.length - 1) $$render(consequent_7);
  ...
  var node_18 = sibling(div_18, 2);
  {
    var consequent_8 = ($$anchor2) => {
      ...
      event("click", div_20, stopPropagation(function($$arg) {
        bubble_event.call(this, $$props, $$arg);
      }));
      transition(3, div_19, () => fade, () => ({ duration: 200 }));
      event("click", div_19, cancelExit);
  ...
  template_effect(
    ($0, $1) => {
      ...
      set_text(text_1, `Question ${get(currentQuestionIndex) + 1} of ${hseQuestions.length ?? ""}`);
  ...
  transition(1, div_8, () => fly, () => ({ y: 20, duration: 300 }));
  transition(2, div_8, () => fly, () => ({ y: -20, duration: 300 }));
  append($$anchor, div);
  pop();
  $$cleanup();
}
...
//# sourceMappingURL=8.BQV_Rdqf.js.map
