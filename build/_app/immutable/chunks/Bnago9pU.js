const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./DVQUq6z-.js","./HJ-2R3CP.js","./BXHzHFYX.js"])))=>i.map(i=>d[i]);
import { b as getAugmentedNamespace, c as commonjsGlobal } from "./HJ-2R3CP.js";
import { _ as __vitePreload } from "./CQrtv1eE.js";
import { ae as writable } from "./BXHzHFYX.js";
import { b as browser$1, s as setLocale } from "./DIcdBaaF.js";
...
class RealtimeClient {
  ...
  connect() {
    ...
    __vitePreload(async () => {
      const { default: WS } = await import("./DVQUq6z-.js").then((n) => n.b);
      return { default: WS };
    }, true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url).then(({ default: WS }) => {
...
const supabaseUrl = "https://sgxsrffocrtrslkaqiee.supabase.co";
const supabaseAnonKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InNneHNyZmZvY3J0cnNsa2FxaWVlIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzgwMDgxNDQsImV4cCI6MjA1MzU4NDE0NH0.aYEE5JZaAl81g5oOrEvpA2xNjdTQsG0oKHKP8jmpVD0";
...
const supabase = createClient(supabaseUrl, supabaseAnonKey, {
  auth: {
    persistSession: true,
    autoRefreshToken: browser$1,
    detectSessionInUrl: browser$1,
...
export {
  clearSupabaseAuth as c,
  isLoading as i,
  supabase as s,
  user as u
};
//# sourceMappingURL=Bnago9pU.js.map
