...
-- Create materialized view for audit stats with a proper unique identifier
...
SELECT
  ...
  recent_audits,
  NOW() as refreshed_at,
  -- Create a guaranteed unique identifier from the grouped columns
  MD5(
...
-- Create a unique index on the stats_id
...
-- Create refresh function that handles concurrent refreshes
